...
agent-tools         # once, and after bumping home/bin/agent-tools.lock
```
...
`bash tests/activation.test.sh`, `nix build .#darwinConfigurations.mac.system --no-link`.

## Read next

- [SETUP.md](SETUP.md): restore a wiped Mac, step by step, and prove it.
- [WORKFLOW.md](WORKFLOW.md): the five levels of working with agents and which harness for what.
